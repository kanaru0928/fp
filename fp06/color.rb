...
class Colors
  ...
  SKIN = Color.normalized(0xff, 0xe1, 0xb4).freeze
  CLOTH = Color.normalized(0x58, 0x58, 0x58).freeze
  CLOTH_DARK = Color.normalized(0x20, 0x20, 0x20).freeze
  MIKU = Color.normalized(0x00, 0xa1, 0xa2).freeze
end
